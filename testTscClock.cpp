...
int32_t main(int32_t argc, char* argv[]) {
    ...
    std::vector<int32_t> vecLoop = {0,     1,     5,     10,    15,    20,    25,    30,    40,    50,    70,    80,
                                    90,    100,   150,   200,   250,   300,   350,   400,   450,   500,   550,   600,
                                    650,   700,   750,   800,   850,   900,   950,   1000,  1500,  2000,  2500,  3000,
    ...
    for (auto v : vecLoop) {
        ...
        endTsc = clock.rdTsc();
        std::cout << "delay" << v << "Ns " << " actual cost:" << clock.tsc2Ns(endTsc - startTsc) / loopCnt << "ns"
                  << std::endl;
    }
